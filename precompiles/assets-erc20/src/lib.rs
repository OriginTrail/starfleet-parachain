            ...
            if pallet_assets::Pallet::<Runtime, Instance>::maybe_total_supply(asset_id.clone()).is_some() {
                let result = {
                    ...
                    match selector {
                        ...
                        Action::IncreaseAllowance => Self::increase_allowance(asset_id, handle),
                        Action::DecreaseAllowance => Self::decrease_allowance(asset_id, handle),
                    }
                };
                return Some(result);
            }
    ...
    <<Runtime as frame_system::Config>::RuntimeCall as Dispatchable>::RuntimeOrigin: OriginTrait,
{
    ...
    fn approve(
        ...
        Self::_approve(handle, asset_id, spender, amount)
    }
    ...
    fn increase_allowance(
        ...
        let spender: H160 = input.read::<Address>()?.into();
        let added_value: U256 = input.read()?;
    ...
    fn decrease_allowance(
        ...
        let spender: H160 = input.read::<Address>()?.into();
        let subtracted_value: U256 = input.read()?;
