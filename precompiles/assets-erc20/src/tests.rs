...
#[test]
fn increase_allowance_saturating() {
    ExtBuilder::default()
        .with_balances(vec![(Account::Alice, 1000)])
        .build()
        .execute_with(|| {
        ...
        .execute_with(|| {
            ...
            precompiles()
                ...
                .prepare_test(
                    Account::Alice,
                    Account::AssetId(0u128),
                    EvmDataWriter::new_with_selector(Action::DecreaseAllowance)
                        .write(Address(Account::Bob.into()))
                        .write(U256::from(200))
                        .build(),
                )
        ...
        .execute_with(|| {
            ...
            precompiles()
                ...
                .expect_log(LogsBuilder::new(Account::AssetId(0u128).into()).log3(
                    ...
                    Account::Alice,
                    Account::Bob,
                    EvmDataWriter::new().write(U256::from(0)).build(),
                ))
                .execute_returns(EvmDataWriter::new().write(true).build());
        });
}
...
fn burn_is_ok() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        assert_eq!(
            Assets::balance(asset_id, &Account::Bob),
